...
```
sync-patches/
└── sync-20240401-120000-acme/           # one subdirectory per delivery
...
- [ ] For `patch` (default): send the `sync-TIMESTAMP-PARTY/` directory to 3rd party; tags updated automatically
